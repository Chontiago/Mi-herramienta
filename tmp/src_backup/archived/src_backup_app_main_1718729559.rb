...
class TimeManageTool
  ...
  def initial_tasks() #Creates new tasks with their respective subtasks as objects to populate the main array
    ...
    @programar ||= TasksAndSubTasks.new('PROGRAMAR',[], [5], false, true).generated_task_and_subtask_hash

    @smash ||= TasksAndSubTasks.new('SMASH', ['PARTIDAS', 'FUNDIES', 'OTRAS'], [2, 2, 1], true, true).generated_task_and_subtask_hash

    @caminar ||= TasksAndSubTasks.new('CAMINAR',['SOLO', 'PERRO'],[3, 2], true, true ).generated_task_and_subtask_hash
