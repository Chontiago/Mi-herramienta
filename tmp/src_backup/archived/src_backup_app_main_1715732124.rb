...
class TimeManageTool
  ...
  def new_task_screen()
    ...
    @new_task.each_with_index do |new_task, index_y|
      ...
      @args.inputs.text.each do |input|
        if @start_typing == true
          @selected_option_full.append(input)
        end
      ...
      #@args.outputs.labels << {x: 1280 / 2, y: 100, anchor_x: 0.5, anchor_y: 0.5, r: 0, g: 0, b: 255, text:"#{@selected_option}"}
      #@args.outputs.labels << {x: 1280 / 2, y: 200, anchor_x: 0.5, anchor_y: 0.5, r: 0, g: 0, b: 255, text:"#{@selected_option_full}"}
      @args.outputs.labels << {x: 1280 / 2, y: 300, anchor_x: 0.5, anchor_y: 0.5, r: 0, g: 0, b: 255, text:"#{@start_typing}"}
