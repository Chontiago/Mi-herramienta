...
class TimeManageTool
  ...
  def render_new_task_button
    @new_task_buttons = [@main_button_text, "BACK"]



    
    @new_task_buttons.each_with_index do |item, index_x|
      @create_task_button_borders = {x: (index_x * TILE_WIDTH) + HALF_SCREEN_X, y: @main_buttons_y_position, w: TILE_WIDTH, h: TILE_HEIGHT, r: 255, g:255, b: 255} 
      @create_task_button = {x: (index_x * TILE_WIDTH) + HALF_SCREEN_X, y: @main_buttons_y_position, w: TILE_WIDTH, h: TILE_HEIGHT, r: 0, g:0, b: 255} 
      @create_task_text = {x: grid_x + centered_width, y: grid_y + centered_height , anchor_x: 0.5, anchor_y: 0.5, r: 255, g: 255, b: 255, text:item} 
