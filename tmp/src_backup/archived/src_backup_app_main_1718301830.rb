...
class TimeManageTool
  ...
  def create_objective_or_subo_objective_sceen() #Takes the user to the appropiate screen, depending of if he wants to create a task with a single objective or a task with multiple subtasks and subobjectives
  ...
  def new_task_user_input
    ...
    @user_input.append(@args.inputs.text.first)
