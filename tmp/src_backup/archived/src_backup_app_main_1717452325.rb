...
class TimeManageTool
  ...
  def render_grid_and_items()
    @main_array.each_with_index do |collumn, index_y|
      collumn.each_with_index do |item, index_x|
        ...
        @main_buttons_y = (index_y - 10) - TILE_HEIGHT + HALF_SCREEN_Y # Used for new, edit, and back buttons in the main buttons function 
  ...
  def render_new_task_button
    ...
    @new_task_buttons.each_with_index do |item, index_x|
      @create_task_button= {x: (index_x * TILE_WIDTH) + HALF_SCREEN_X, y: @button_y, w: TILE_WIDTH, h: TILE_HEIGHT, r: 0, g:0, b: 255} 
