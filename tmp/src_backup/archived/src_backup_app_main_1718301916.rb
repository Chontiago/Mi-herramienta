...
class TimeManageTool
  ...
  def create_objective_or_sub_objective_sceen() #Takes the user to the appropiate screen, depending of if he wants to create a task with a single objective or a task with multiple subtasks and subobjectives
