...
class TimeManageTool
  ...
  def add_or_substract_to_objective() # When th eplus or substract button is pressed on the task or the subtask, adds or subtracts to the objective/subobjective
