...
class TimeManageTool
  ...
  def main_buttons_functionality
    ...
    elsif mouse_click(@args.inputs.mouse.point, @create_task_button) && @main_button_text == "NEW TASK" #Changes from the main task and subtask screen to the new task creator
